...
export default function Screen() {
  return (
    <div className="relative bg-[#060816]">
      <Popover className="relative bg-[#060816] shadow">
        {({ open }) => (
          <>
                        ...
                        >
                          ...
                          >
                            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                              ...
                              <div className="px-5 py-5 bg-gray-50 flex space-y-0 space-x-10 ">
                    ...
                    {({ open }) => (
                      <>
                        ...
                        >
                          <Popover.Panel
                            static
                            className="absolute left-1/2 z-10 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md"
                          >
                            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                              <div className="relative grid gap-6 bg-white px-5 py-6 p-8">
                                {resources.map((item) => (
